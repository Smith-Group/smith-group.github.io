...
- param_list:
  ...
  param_list, fit_input, or fit_output structure

- tables:

  list with resonance/nuclei/couplings tables to update

## Value

A named \`list\` with updated \`resonances\`, \`nuclei\`, and
\`couplings\` data frames.
